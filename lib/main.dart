...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'TwoActivity_26'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _onPressed(){
     setState(() {
      _textView = _textInputController.text;
    });
  }
  @override
  Widget build(BuildContext context) {
        ...
        child: Column(
          ...
          children: <Widget>[
            Column(
              ...
              Text('$_textView', style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.w400),),
            ],),
            Column(
